          ...
          <div className="w-full pb-2 h-full flex flex-col justify-between relative bg-gray-800">
            ...
            <div className="relative w-full">
              ...
              <div className="relative z-10 flex flex-row">
                <Textarea ref={inputRef} className={`p-2 border rounded-lg w-full resize-none h-14 bg-background text-white`} placeholder="Type a message" value={textboxText} onChange={(e) => setTextboxText(e.target.value)} onKeyDown={handleKeyDown}/>
